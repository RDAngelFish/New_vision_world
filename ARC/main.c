    ...
    while(1)
    {
        ...
        //Pre-Process
        {
            ...
            for(int i = 0; i < 20; i++)    //0~39
            {
                ...
                {
                    predict_data[2 * i] = ((float)real_data[2 * i + 2] - (float)real_data[0]) / 10;
                    predict_data[2 * i + 1] = ((float)real_data[2 * i + 3] - (float)real_data[1]) / 10;
                }
                else
                {
                    predict_data[2 * i] = ((float)real_data[2 * i + 2] - (float)real_data[2 * i]) / 10;
                    predict_data[2 * i + 1] = ((float)real_data[2 * i + 3] - (float)real_data[2 * i + 1]) / 10;
                }
            } 
            //left hand
            for(int i = 21; i < 41; i++)   //40~79
            {
                if((i == 25) || (i == 29) || (i == 33) || (i == 37))
                {
                    predict_data[2 * i - 2] = ((float)real_data[2 * i + 2] - (float)real_data[42]) / 10;
                    predict_data[2 * i - 1] = ((float)real_data[2 * i + 3] - (float)real_data[43]) / 10;
                }
                else
                {
                    predict_data[2 * i - 2] = ((float)real_data[2 * i + 2] - (float)real_data[2 * i]) / 10;
                    predict_data[2 * i - 1] = ((float)real_data[2 * i + 3] - (float)real_data[2 * i + 1]) / 10;
                }
            }  
        }
        ...
        {
            voice_info = 0;
            //voice_info 31,30 : 2'b00 = none / 2'b01 = piano / 2'b10 = drum / 2'b11 = guitar
                //drum,guitar
                    //29,28 : 2'b00 = none / 2'b01 = voice r / 2'b10 = voice l / 2'b11 = voice 3
            ...
            if(final_anw == 0)
            {
                ...
                {	
					...
					if(((real_data[8 * i + 9 + j] - hand_top_point[i]) > 8) && ((real_data[8 * i + 9 + j] - hand_top_point[i]) < 50))
					{
						//bound
						if(real_data[8 * i + 8 + j] < 54)                       //left bound 320 - 14 * 19
						{
							info_index = 0;
						}
						else if (real_data[8 * i + 8 + j] > 567)                //right bound 320 + 13 * 19
						{
							info_index = 27;
						}
						else
						{
							info_index = (real_data[8 * i + 8 + j] - 54) / 19;  //left offset
						}     
            ...
            else
            {
                ...
                {
                    voice_info |= 0x1 << 31;        //31,30 = 2'b11
                    voice_info |= 0x1 << 30;        //31,30 = 2'b11
                    if((real_data[9] - r_hand_y) > 50)   
                    {
                        voice_info |= 0x1 << 28;
                    } 
                ...
                //hand information
                {
                    ...
                    {
                        info_index = (real_data[0] - 70) / 5;
                    }
                    voice_info += info_index << 7;      //13~7
                    //right hand y_index
                    if(real_data[1] > 490)
                    {
                        info_index = 100;
                    ...
                    {
                        info_index = (real_data[1] + 10) / 5;
                    }
                    voice_info += info_index;           //6~0 
                    //left hand x_index
                    if(real_data[42] > 570)
                    {
                        info_index = 100;
                    ...
                    {
                        info_index = (real_data[42] - 70) / 5;
                    }
                    voice_info += info_index << 21;     //27~21
                    //left hand y_index
                    if(real_data[43] > 490)
                    {
                        info_index = 100;
                    ...
                    {
                        info_index = (real_data[43] + 10) / 5;
                    }
                    voice_info += info_index << 14;     //20~14
                }                
            }
        }
